...
*Hᴇʟʟᴏ {} * [!]({})
───────────────────────
× *I'ᴍ Gʀᴏᴜᴘ Mᴀɴᴀɢᴇᴍᴇɴᴛ+Music Bᴏᴛ*
× *I'ᴍ Vᴇʀʏ Fᴀꜱᴛ Aɴᴅ Mᴏʀᴇ Eꜰꜰɪᴄɪᴇɴᴛ I Pʀᴏᴠɪᴅᴇ Aᴡᴇꜱᴏᴍᴇ Fᴇᴀᴛᴜʀᴇꜱ!*
───────────────────────
× *Uᴘᴛɪᴍᴇ:* `{}`
× `{}` *Uꜱᴇʀ, Aᴄʀᴏꜱꜱ* `{}` *Cʜᴀᴛꜱ.*
───────────────────────
× *Pᴏᴡᴇʀᴇᴅ Bʏ:* @SuryaBots"""
...
we updradge 𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁 everyday to simplifie use of telegram and give a better exprince to users.
Click on below buttons and check amazing tools for users.""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Afk", callback_data="tiana_toola"),
                    InlineKeyboardButton(text="Chatbot", callback_data="tiana_toolb"),
                    InlineKeyboardButton(text="Couples", callback_data="tiana_toolc"),
                 ],
                 [
                    InlineKeyboardButton(text="Fake-Info", callback_data="tiana_toolg"),
                    InlineKeyboardButton(text="Font Gen", callback_data="tiana_toold"),
                    InlineKeyboardButton(text="Get-Qr", callback_data="tiana_toolh"),
                 ],
                 [
                    InlineKeyboardButton(text="Paste", callback_data="tiana_toole"),
                    InlineKeyboardButton(text="Pokedex", callback_data="tiana_tooli"),
                    InlineKeyboardButton(text="Telegraph", callback_data="tiana_toolf"),
                 ],
                 [
...
support image,gifs ,video stickers also""",
 ...
 - /chatbot : Shows chatbot control panel""",
        ...
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Couples」:
 - /couples : To Choose Couples Of The Day""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="tiana_tools")]]
            ),
 ...
 - /txt :Get Telegraph Link Of Replied Text""",
    ...
    elif query.data == "tiana_toolg":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Fake-Info 」:

To generate fake information and photo:
 - /picgen (for fake photo)
 - /fakegen (to generate fake information)""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="tiana_tools")]]
            ),
        )
    elif query.data == "tiana_toolh":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Get Qr」:
 ...
 - /makeqr (content): make a qr code from the given message (text, link, etc...)""",
    ...
    elif query.data == "tiana_tooli":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Pokedex 」:
 - /pokedex (Pokemon name) - give the details about pokemon.""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="tiana_tools")]]
            ),
...
Cʟɪᴄᴋ  Bᴇʟᴏᴡ  Bᴜᴛᴛᴏɴ  Tᴏ  Aᴅᴅ  Bᴏᴛ  Iɴ  Yᴏᴜʀ  Gʀᴏᴜᴘ. Bᴀsɪᴄ  Tᴏᴜʀ  Sᴛᴀʀᴛᴇᴅ  Tᴏ  Kɴᴏᴡ  Aʙᴏᴜᴛ  Hᴏᴡ  Tᴏ  Usᴇ  Mᴇ*""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="𝙎𝙚𝙩𝙪𝙥 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡 🎥", callback_data="spidey_vida")],
               [InlineKeyboardButton(text="➕️ 𝘼𝙙𝙙 𝙢𝙚 𝙩𝙤 𝙔𝙤𝙪𝙧 𝙂𝙧𝙤𝙪𝙥 ➕️", url=f"https://t.me/{BOT_USERNAME}?startgroup=true&admin=manage_chat+change_info+post_messages+edit_messages+delete_messages+invite_users+restrict_members+pin_messages+promote_members+manage_video_chats+anonymous=false")],       
                [InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="tiana_"),
...
3). Gɪᴠɪɴɢ  Fᴜʟʟ  Pᴇʀᴍɪssɪᴏɴs  Mᴀᴋᴇ 𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁  Fᴜʟʟʏ  Usᴇғᴜʟ</b>""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
...
Hᴇʀᴇ  Aʀᴇ  Sᴏᴍᴇ  Essᴇɴᴛɪᴀʟᴛ  Tᴏ  Tʀʏ  Oɴ SuryaRobot.
...
• We also thank all the groups who rely on our Bot for this service, we hope you will always like it: we are constantly working to improve it!""",
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Status", url=f"https://t.me/SuryaBotsStatus/2"),
                    InlineKeyboardButton(text="Logs", url=f"https://t.me/{LOGGER_CHAT}"),
                 ],
                 [
        ...
        query.message.edit_text(
            text="""*𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁 is No more Open Source Bot Project.*

*Sorry You Can't Get Source*""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
def tiana_about_callback(update: Update, context: CallbackContext):
            ...
            reply_markup=InlineKeyboardMarkup(
               [
                 [
                     ...
                     InlineKeyboardButton(text="🤖 𝘽𝙤𝙩𝙨 𝙡𝙞𝙨𝙩", url=f"https://t.me/SuryaBots/5"),
                 ],
                 [  
    ...
    elif query.data == "spidey_vida":
        query.message.send_video(TIANA_VIDA, parse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True)
...
def main():
    ...
    settings_handler = CommandHandler("uioputrsettings", get_settings, run_async=True)
    settings_callback_handler = CallbackQueryHandler(settings_button, pattern=r"stngs_", run_async=True)

    about_callback_handler = CallbackQueryHandler(tiana_callback_handler, pattern=r"tiana_", run_async=True)
    Tiana_callback_handler = CallbackQueryHandler(tiana_about_callback, pattern=r"about_", run_async=True)
    ...
    if WEBHOOK:
        ...
        LOGGER.info("SuryaRobot Started Successfully")
