...
*Admins only:*
 ❍ /cleanblue <on/off or yes/no>*:* command clean mode 
 ❍ /ignoreblue <command name>*:* command you want to ignore
 ❍ /unignoreblue <command name>*:* command you want to unignore
 ❍ /listblue*:* show the list of all bluetext cleaning
 ❍ /nightmode <on/off>*:* close the group in night(12 AM) and open in the morning (6 AM)
