...
from Tianabot import NO_LOAD, UPDATE_CHANNEL, SUPPORT_CHAT
    ...
    if len(pairs) > 3:
        pairs = pairs[modulo_page * 7 : 7 * (modulo_page + 1)] + [
            (
                ...
                EqInlineKeyboardButton("Go Back", callback_data="tiana_"),
                EqInlineKeyboardButton(
        ...
        pairs += [[EqInlineKeyboardButton("Go Back", callback_data="tiana_")]]
