    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁 chatbot disabled by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁 chatbot enabled by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        url = f"https://kukiapi.xyz/api/apikey=5147179137-KUKIbf3eAM8yu1/Spidey/Suraj/message={anon}" 
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁 Enable Chats</b>\n"
    for chat in chats:
        try:
