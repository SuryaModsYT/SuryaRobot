...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'JARVISMOD'."
        disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/SuryaBotsStatus/4"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/SuryaBotsStatus/5")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current 𝗦𝘂𝗿𝘆𝗮 𝗥𝗼𝗯𝗼𝘁's Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/SuryaBotsStatus/4)
"""
